	...
	[50] = {
		[1] = {
			[1] = {
				...
				["location"] = "Anelace the Clairvoyant (Deadwind Pass - Morgan\'s Plot "..NORMAL.."41, 79"..WHITE..")",
				["note"] = "\'Obsidian Rod\' is at "..NORMAL.."Lower Karazhan Halls [e]"..WHITE..". \'Cosmic Residue\' drops from "..NORMAL.."[3]"..WHITE..". \'The Binding of Xanthar\' prequest starts at Hanvar the Righteous (Deadwind Pass - Morgan\'s Plot "..NORMAL.."41, 79"..WHITE.."), \'Wine for Kyleson\' prequest starts at The Cook ("..NORMAL.."Lower Karazhan Halls [e]"..WHITE..").",
				["attain"] = 60,
				["level"] = 60,
				["prequest"] = "Wine for Kyleson, The Binding of Xanthar",
				["followup"] = "Tirisfal\'s Vestige",
				["rewards"] = {
					[1] = { ["id"] = 41413, ["name"] = "Scepter Rod of Medivh", ["subtext"] = "Quest Item", ["icon"] = "INV_Staff_30", ["quality"] = 1 },
				},
			},
			[2] = {
				["id"] = 41370,
				...
				["location"] = "Anelace the Clairvoyant (Deadwind Pass - Morgan\'s Plot "..NORMAL.."41, 79"..WHITE..")",
				["note"] = "Drops from "..NORMAL.."Echo of Medivh [4]"..WHITE..". \'Khadgar\'s Journal\' starts this quest chain. \'Sanv K\'la\' (Swamp of Sorrows "..NORMAL.."25, 30"..WHITE..") starts the Sanv Charm quest chain.",
				["attain"] = 60,
				["level"] = 60,
				...
				["rewards"] = {
					[1] = { ["id"] = 41415, ["name"] = "The Scepter of Medivh", ["subtext"] = "Quest Item, Open Portal", ["icon"] = "INV_Staff_30", ["quality"] = 1 },
				},
			},
			[3] = {
				["id"] = 41343,
				...
				["location"] = "Big Whiskers (Tower of Karazhan "..NORMAL.."50, 50"..WHITE..")",
				["note"] = RED.."Mage only! "..WHITE.."Doorman Montigue is in Lower Karazhan Halls at the beginning of the dungeon in front of the stairs.",
				["attain"] = 60,
				["level"] = 61,
			...
			[4] = {
				...
				["location"] = "Recipes of Kezan (Tower of Karazhan "..NORMAL.."near [1]"..WHITE..")",
				["note"] = "The Cook is near "..NORMAL.."Lower Karazhan Halls [e]"..WHITE..". A quest to obtain a cooking recipe.",
				["attain"] = 60,
				["level"] = 60,
			...
			[5] = {
				...
				["location"] = "Enchanted Amethyst (Tower of Karazhan, drops from "..NORMAL.."[2]"..WHITE.." boss)",
				["note"] = "Quest line continues at Stormwind Vault as "..NORMAL.."The Enemy Lays"..WHITE.." quest.",
				["attain"] = 60,
				["level"] = 62,
			...
			[6] = {
				...
				["note"] = RED.."Druid only! "..WHITE.."Lorekeeper Lydros (Dire Maul - West or North "..NORMAL.."[1] Library"..WHITE.."). Quest line for [Glyph of the Arcane Treant] at Dire Maul East.",
				["attain"] = 60,
				["level"] = 61,
			...
			[7] = {
				...
				["location"] = "Arch Druid Dreamwind (Hyjal - Nordrassil "..NORMAL.."85, 30"..WHITE..")",
				["note"] = "\'Vorgendor: Myths from the Blood Dimension\' (near the entrance) contains the quest item. Prequest starts with \'The Scythe of Elune\', which drops from Lord Blackwood II ("..NORMAL.."Lower Karazhan Halls [5]"..WHITE..").",
				["attain"] = 60,
				["level"] = 60,
			...
			[8] = {
				...
				["location"] = "Arch Druid Dreamwind (Hyjal - Nordrassil "..NORMAL.."85, 30"..WHITE..")",
				["note"] = "\'Keeper Gnarlmoon\' is at "..NORMAL.."[1]"..WHITE..". Prequest starts with \'The Scythe of Elune\', which drops from Lord Blackwood II ("..NORMAL.."Lower Karazhan Halls [5]"..WHITE..").",
				["attain"] = 60,
				["level"] = 60,
			...
			[9] = {
				...
				["location"] = "Arch Druid Dreamwind (Hyjal - Nordrassil "..NORMAL.."85, 30"..WHITE..")",
				["note"] = "\'Soul of a Dreadlord\' drops from "..NORMAL.."Mephistroth [8]"..WHITE..". Prequest starts with \'The Scythe of Elune\', which drops from Lord Blackwood II ("..NORMAL.."Lower Karazhan Halls [5]"..WHITE.."). Mooncloth from Tailoring, Eternal Dreamstone Shard from Enchanting.",
				["attain"] = 60,
				["level"] = 60,
				["prequest"] = "Scythe of the Goddess -> Pricolich Lycan",
				["followup"] = "The Power of the Goddess",
				["rewards"] = {
					[1] = { ["id"] = 55505, ["name"] = "The Scythe of Elune", ["subtext"] = "Trinket", ["icon"] = "INV_Jewelry_Trinket_01", ["quality"] = 3 },
				},
			},
		},
		[2] = {
			[1]  = { ["id"] = 41369, ["title"] = "The Scepter Rod of Medivh", ["aim"] = "To restore the Scepter Rod of Medivh, Anelace the Clairvoyant at Morgan\'s Plot in Deadwind Pass needs a high amount of arcane energy.", ["location"] = "Anelace the Clairvoyant (Deadwind Pass - Morgan\'s Plot "..NORMAL.."41, 79"..WHITE..")", ["note"] = "\'Obsidian Rod\' is at "..NORMAL.."Lower Karazhan Halls [e]"..WHITE..". \'Cosmic Residue\' drops from "..NORMAL.."[3]"..WHITE..". \'The Binding of Xanthar\' prequest starts at Hanvar the Righteous (Deadwind Pass - Morgan\'s Plot "..NORMAL.."41, 79"..WHITE.."), \'Wine for Kyleson\' prequest starts at The Cook ("..NORMAL.."Lower Karazhan Halls [e]"..WHITE..").", ["attain"] = 60, ["level"] = 60, ["prequest"] = "Wine for Kyleson, The Binding of Xanthar", ["followup"] = "Tirisfal\'s Vestige", ["rewards"] = { [1] = { ["id"] = 41413, ["name"] = "Scepter Rod of Medivh", ["subtext"] = "Quest Item", ["icon"] = "INV_Staff_30", ["quality"] = 1 } } },
			[2]  = { ["id"] = 41370, ["title"] = "Tirisfal\'s Vestige", ["aim"] = "A figment of Medivh is necessary to imbue the Scepter of Medivh with. Bring it to Anelace the Clairvoyant at Morgan\'s Plot outside Karazhan.", ["location"] = "Anelace the Clairvoyant (Deadwind Pass - Morgan\'s Plot "..NORMAL.."41, 79"..WHITE..")", ["note"] = "Drops from "..NORMAL.."Echo of Medivh [4]"..WHITE..". \'Khadgar\'s Journal\' starts this quest chain. \'Sanv K\'la\' (Swamp of Sorrows "..NORMAL.."25, 30"..WHITE..") starts the Sanv Charm quest chain.", ["attain"] = 60, ["level"] = 60, ["prequest"] = "Clutch of Thanlar -> Restoration", ["followup"] = "The Sanv Charm -> A Favor Asked -> The Otherwordly Scepter of Medivh -> A Pathway Opened", ["rewards"] = { [1] = { ["id"] = 41415, ["name"] = "The Scepter of Medivh", ["subtext"] = "Quest Item, Open Portal", ["icon"] = "INV_Staff_30", ["quality"] = 1 } } },
			[3]  = { ["id"] = 41343, ["title"] = "I Am No Rat", ["aim"] = "Speak to Doorman Montigue in Lower Karazhan Halls.", ["location"] = "Big Whiskers (Tower of Karazhan "..NORMAL.."50, 50"..WHITE..")", ["note"] = RED.."Mage only! "..WHITE.."Doorman Montigue is in Lower Karazhan Halls at the beginning of the dungeon in front of the stairs.", ["attain"] = 60, ["level"] = 61, ["followup"] = "Comically Large Candle" },
			[4]  = { ["id"] = 41373, ["title"] = "A Chef\'s Majesty", ["aim"] = "Find The Cook in Lower Karazhan Halls.", ["location"] = "Recipes of Kezan (Tower of Karazhan "..NORMAL.."near [1]"..WHITE..")", ["note"] = "The Cook is near "..NORMAL.."Lower Karazhan Halls [e]"..WHITE..". A quest to obtain a cooking recipe.", ["attain"] = 60, ["level"] = 60, ["followup"] = "No Honor Among Chefs" },
			[5]  = { ["id"] = 41353, ["title"] = "Cold is the Night", ["aim"] = "Investigate the mysteries of the Enchanted Amethyst.", ["location"] = "Enchanted Amethyst (Tower of Karazhan, drops from "..NORMAL.."[2]"..WHITE.." boss)", ["note"] = "Quest line continues at Stormwind Vault as "..NORMAL.."The Enemy Lays"..WHITE.." quest.", ["attain"] = 60, ["level"] = 62, ["followup"] = "Embraced by the Moon" },
			[6]  = { ["id"] = 41375, ["title"] = "A Study of Magical Trees", ["aim"] = "Travel to Dire Maul and seek Lorekeeper Lydros.", ["location"] = "Of Ancients and Treants (Tower of Karazhan)", ["note"] = RED.."Druid only! "..WHITE.."Lorekeeper Lydros (Dire Maul - West or North "..NORMAL.."[1] Library"..WHITE.."). Quest line for [Glyph of the Arcane Treant] at Dire Maul East.", ["attain"] = 60, ["level"] = 61, ["followup"] = "Wrapping Warpwood" },
			[7]  = { ["id"] = 41087, ["title"] = "Scythe of the Goddess", ["aim"] = "Retrieve a copy of \'Vorgendor: Myths from the Blood Dimension\' from Upper Karazhan.", ["location"] = "Arch Druid Dreamwind (Hyjal - Nordrassil "..NORMAL.."85, 30"..WHITE..")", ["note"] = "\'Vorgendor: Myths from the Blood Dimension\' (near the entrance) contains the quest item. Prequest starts with \'The Scythe of Elune\', which drops from Lord Blackwood II ("..NORMAL.."Lower Karazhan Halls [5]"..WHITE..").", ["attain"] = 60, ["level"] = 60, ["prequest"] = "Scythe of the Goddess (Lower Karazhan Halls)", ["followup"] = "Scythe of the Goddess" },
			[8]  = { ["id"] = 41384, ["title"] = "Pricolich Gnarlmoon", ["aim"] = "Slay Keeper Gnarlmoon. He can be found in the Upper Chambers of Karazhan.", ["location"] = "Arch Druid Dreamwind (Hyjal - Nordrassil "..NORMAL.."85, 30"..WHITE..")", ["note"] = "\'Keeper Gnarlmoon\' is at "..NORMAL.."[1]"..WHITE..". Prequest starts with \'The Scythe of Elune\', which drops from Lord Blackwood II ("..NORMAL.."Lower Karazhan Halls [5]"..WHITE..").", ["attain"] = 60, ["level"] = 60, ["prequest"] = "Scythe of the Goddess -> Wisdom of Ur", ["followup"] = "Gilnean Pricolich" },
			[9]  = { ["id"] = 41394, ["title"] = "Scythe of the Goddess", ["aim"] = "Bring 6 Eternal Dreamstone Shards, 20 Mooncloth and a Soul of a Dreadlord to Arch Druid Dreamwind.", ["location"] = "Arch Druid Dreamwind (Hyjal - Nordrassil "..NORMAL.."85, 30"..WHITE..")", ["note"] = "\'Soul of a Dreadlord\' drops from "..NORMAL.."Mephistroth [8]"..WHITE..". Prequest starts with \'The Scythe of Elune\', which drops from Lord Blackwood II ("..NORMAL.."Lower Karazhan Halls [5]"..WHITE.."). Mooncloth from Tailoring, Eternal Dreamstone Shard from Enchanting.", ["attain"] = 60, ["level"] = 60, ["prequest"] = "Scythe of the Goddess -> Pricolich Lycan", ["followup"] = "The Power of the Goddess", ["rewards"] = { [1] = { ["id"] = 55505, ["name"] = "The Scythe of Elune", ["subtext"] = "Trinket", ["icon"] = "INV_Jewelry_Trinket_01", ["quality"] = 3 } } },
		},
	...
	[52] = {
		[1] = {
			[1] = {
				...
				["location"] = "Riftmaster Ral\'pekta (Moonwhisper Coast - Moro\'gai Village "..NORMAL.."65, 63"..WHITE..")",
				["note"] = "\'Selenaxx Foulheart\' is at "..NORMAL.."[7]"..WHITE..".",
				["attain"] = 50,
				["level"] = 60,
				["prequest"] = "Ar\'lia of the Moro\'gai -> Wolf in Sheep\'s Clothing -> An Ill Omen ->> Out of the Moonlight",
				["rewards"] = {
					[1] = { ["id"] = 33361, ["name"] = "Bracelet of the Defender",  ["subtext"] = L.WRIST..", "..L.PLATE,   ["icon"] = "INV_Bracer_07", ["quality"] = 3 },
					[2] = { ["id"] = 33362, ["name"] = "Bracelet of the Visionary", ["subtext"] = L.WRIST..", "..L.CLOTH,   ["icon"] = "INV_Bracer_07", ["quality"] = 3 },
					[3] = { ["id"] = 33363, ["name"] = "Bracelet of the Ravager",   ["subtext"] = L.WRIST..", "..L.LEATHER, ["icon"] = "INV_Bracer_07", ["quality"] = 3 },
					[4] = { ["id"] = 33364, ["name"] = "Bracelet of the Oracle",    ["subtext"] = L.WRIST..", "..L.MAIL,    ["icon"] = "INV_Bracer_07", ["quality"] = 3 },
				},
			},
			[2] = {
				["id"] = 41930,
				...
				["location"] = "Narkogg the Dark (Azshara - Maw of Ursoc "..NORMAL.."39, 21"..WHITE..")",
				["note"] = "\'Pendant of the Sentinel\' drops from \'Karrsh the Sentinel\' ("..NORMAL.."[1]"..WHITE..").",
				["attain"] = 60,
				["level"] = 60,
			...
			[4] = {
				...
				["location"] = "Narkogg the Dark (Azshara - Maw of Ursoc "..NORMAL.."39, 21"..WHITE..")",
				["note"] = "\'Heart of Nemasra\' drops from \'Nemasra\' (Un\'goro Crater "..NORMAL.."35, 25"..WHITE.."), \'Grammon\'s Tongue\' from \'Grammon the Ageless\' (Feralas "..NORMAL.."28, 95"..WHITE.."), \'Vial of Purification\' from \'Tidelord Rrurgaz\' (Dustwallow Marsh "..NORMAL.."76, 20"..WHITE..").",
				["attain"] = 60,
				["level"] = 60,
			...
			[5] = {
				...
				["rewards"] = {
					[1] = { ["id"] = 42234, ["name"] = "Essence of Purification", ["subtext"] = "Quest Item", ["icon"] = "INV_Misc_Flask_01", ["quality"] = 1 },
				},
			},
			[6] = {
				["id"] = 42021,
			...
			[7] = {
				...
				["location"] = "Narkogg the Dark (Azshara - Maw of Ursoc "..NORMAL.."39, 21"..WHITE..")",
				["note"] = "\'Ursol\' is at "..NORMAL.."[9]"..WHITE..".",
				["attain"] = 60,
				["level"] = 60,
				["prequest"] = "Unbridled Darkness",
				["rewards"] = {
					[1] = { ["id"] = 42235, ["name"] = "Eternal Essence of Purification", ["subtext"] = "Quest Item", ["icon"] = "INV_Misc_Flask_02", ["quality"] = 1 },
				},
			},
			[8] = {
				["id"] = 42022,
				...
				["location"] = "Corrupted Hide of Ursol (Timbermaw Hold "..NORMAL.."[9]"..WHITE..")",
				["note"] = "\'Kathor the Brave\' is at Azshara - Maw of Ursoc "..NORMAL.."[39, 21]"..WHITE..".",
				["attain"] = 60,
				["level"] = 60,
				["prequest"] = "Unbridled Darkness",
				["rewards"] = {
					[1] = { ["id"] = 33324, ["name"] = "Breastplate of the Wild God",      ["subtext"] = L.CHEST..", "..L.PLATE,   ["icon"] = "INV_Chest_Plate07",  ["quality"] = 3 },
					[2] = { ["id"] = 33325, ["name"] = "Helmet of Natural Benevolence",    ["subtext"] = L.HEAD..", "..L.LEATHER,  ["icon"] = "INV_Helmet_32",      ["quality"] = 3 },
					[3] = { ["id"] = 33326, ["name"] = "Leggings of Untamed Strength",     ["subtext"] = L.LEGS..", "..L.MAIL,     ["icon"] = "INV_Pants_Mail_14",  ["quality"] = 3 },
				},
			},
			[9] = {
				["id"] = 41966,
				...
				["location"] = "Gorn One Eye (Timbermaw Tunnels "..NORMAL.."30, 64"..WHITE..")",
				["note"] = "Prequest start at Nathok (Azshara - Maw of Ursoc "..NORMAL.."39, 20"..WHITE.."). \'Peroth\'arn\' is at "..NORMAL.."[10]"..WHITE..".",
				["attain"] = 60,
				["level"] = 60,
				["prequest"] = "Purging Flames ("..NORMAL.."Molten Core"..WHITE..")",
				["rewards"] = {
					[1] = { ["id"] = 42242, ["name"] = "Sacred Timbermaw Satchel", ["subtext"] = "Container", ["icon"] = "INV_Misc_Bag_11", ["quality"] = 3 },
				},
			},
			[10] = {
				["id"] = 41937,
				...
				["location"] = "\'Pendant of Dreams\' drops from \'Ursol\' at "..NORMAL.."[9]"..WHITE..".",
				["note"] = "Great Bear Spirit (Moonglade "..NORMAL.."39, 27"..WHITE..")",
				["attain"] = 60,
				["level"] = 60,
				["rewards"] = {
					[1] = { ["id"] = 33327, ["name"] = "Branch of the Emerald Expanse",  ["subtext"] = L.TWOHAND..", "..L.STAFF, ["icon"] = "INV_Staff_30",           ["quality"] = 3 },
					[2] = { ["id"] = 33328, ["name"] = "Wispwoven Loop",                 ["subtext"] = L.RING,                  ["icon"] = "INV_Jewelry_Ring_14",      ["quality"] = 3 },
					[3] = { ["id"] = 33329, ["name"] = "Dreambark Amulet",               ["subtext"] = L.NECK,                  ["icon"] = "INV_Jewelry_Necklace_07",  ["quality"] = 3 },
				},
			},
		},
		[2] = {
			[1]  = { ["id"] = 41953, ["title"] = "Draenethyst Recovery",               ["aim"] = "Enter Timbermaw Hold and retrieve the corrupted draenethyst. Bring them to Riftmaster Ral\'pekta in Moro\'gai Village of Moonwhisper Coast.", ["location"] = "Riftmaster Ral\'pekta (Moonwhisper Coast - Moro\'gai Village "..NORMAL.."65, 63"..WHITE..")", ["note"] = "\'Selenaxx Foulheart\' is at "..NORMAL.."[7]"..WHITE..".", ["attain"] = 50, ["level"] = 60, ["prequest"] = "Ar\'lia of the Moro\'gai -> Wolf in Sheep\'s Clothing -> An Ill Omen ->> Out of the Moonlight", ["rewards"] = { [1] = { ["id"] = 33361, ["name"] = "Bracelet of the Defender",  ["subtext"] = L.WRIST..", "..L.PLATE,   ["icon"] = "INV_Bracer_07", ["quality"] = 3 }, [2] = { ["id"] = 33362, ["name"] = "Bracelet of the Visionary", ["subtext"] = L.WRIST..", "..L.CLOTH,   ["icon"] = "INV_Bracer_07", ["quality"] = 3 }, [3] = { ["id"] = 33363, ["name"] = "Bracelet of the Ravager",   ["subtext"] = L.WRIST..", "..L.LEATHER, ["icon"] = "INV_Bracer_07", ["quality"] = 3 }, [4] = { ["id"] = 33364, ["name"] = "Bracelet of the Oracle",    ["subtext"] = L.WRIST..", "..L.MAIL,    ["icon"] = "INV_Bracer_07", ["quality"] = 3 } } },
			[2]  = { ["id"] = 41930, ["title"] = "Proof of Conviction",                ["aim"] = "Present Narkogg the Dark in the Maw of Ursoc in Azshara with proof of slaying Karrsh the Sentinel in Timbermaw Hold.", ["location"] = "Narkogg the Dark (Azshara - Maw of Ursoc "..NORMAL.."39, 21"..WHITE..")", ["note"] = "\'Pendant of the Sentinel\' drops from \'Karrsh the Sentinel\' ("..NORMAL.."[1]"..WHITE..").", ["attain"] = 60, ["level"] = 60, ["followup"] = "The Corruption of Timbermaw Hold" },
			[3]  = { ["id"] = 41931, ["title"] = "The Corruption of Timbermaw Hold",  ["aim"] = "Collect Withermaw Totems from Withermaw Shaman inside Timbermaw Hold and bring them to Narkogg the Dark in the Maw of Ursoc in Azshara.", ["location"] = "Narkogg the Dark (Azshara - Maw of Ursoc "..NORMAL.."39, 21"..WHITE..")", ["note"] = "\'Withermaw Shaman\' can be found inside Timbermaw Hold.", ["attain"] = 60, ["level"] = 60, ["prequest"] = "Proof of Conviction", ["followup"] = "Ancient Furbolg Remedies" },
			[4]  = { ["id"] = 41932, ["title"] = "Ancient Furbolg Remedies",          ["aim"] = "Narkogg the Dark in the Maw of Ursoc in Azshara requires specific materials for the purification salve. Bring them to him.", ["location"] = "Narkogg the Dark (Azshara - Maw of Ursoc "..NORMAL.."39, 21"..WHITE..")", ["note"] = "\'Heart of Nemasra\' drops from \'Nemasra\' (Un\'goro Crater "..NORMAL.."35, 25"..WHITE.."), \'Grammon\'s Tongue\' from \'Grammon the Ageless\' (Feralas "..NORMAL.."28, 95"..WHITE.."), \'Vial of Purification\' from \'Tidelord Rrurgaz\' (Dustwallow Marsh "..NORMAL.."76, 20"..WHITE..").", ["attain"] = 60, ["level"] = 60, ["prequest"] = "The Corruption of Timbermaw Hold", ["followup"] = "Unbridled Darkness" },
			[5]  = { ["id"] = 41933, ["title"] = "Unbridled Darkness",                ["aim"] = "Retrieve Narkogg\'s Medicine Pouch and the Putrid Flower from within Timbermaw Hold for Narkogg the Dark in the Maw of Ursoc in Azshara.", ["location"] = "Narkogg the Dark (Azshara - Maw of Ursoc "..NORMAL.."39, 21"..WHITE..")", ["note"] = "\'Narkogg\'s Medicine Pouch\' and \'Putrid Flower\' are inside Timbermaw Hold.", ["attain"] = 60, ["level"] = 60, ["prequest"] = "Ancient Furbolg Remedies", ["followup"] = "What Remains / Essence of Purification / Hide of a Wild God", ["rewards"] = { [1] = { ["id"] = 42234, ["name"] = "Essence of Purification", ["subtext"] = "Quest Item", ["icon"] = "INV_Misc_Flask_01", ["quality"] = 1 } } },
			[6]  = { ["id"] = 42021, ["title"] = "Essence of Purification",           ["aim"] = "Bring the required reagents to Narkogg the Dark in the Maw of Ursoc in Azshara to craft the Essence of Purification.", ["location"] = "Narkogg the Dark (Azshara - Maw of Ursoc "..NORMAL.."39, 21"..WHITE..")", ["note"] = "Bring 1x \'Timbermaw Sap\', 2x \'Essence of Earth\' and 2x \'Living Essence\' to Narkogg the Dark.", ["attain"] = 60, ["level"] = 60, ["prequest"] = "Unbridled Darkness", ["rewards"] = { [1] = { ["id"] = 42234, ["name"] = "Essence of Purification", ["subtext"] = "Quest Item", ["icon"] = "INV_Misc_Flask_01", ["quality"] = 1 } } },
			[7]  = { ["id"] = 41934, ["title"] = "What Remains",                      ["aim"] = "Slay Ursol in Timbermaw Hold. Report to Narkogg the Dark in the Maw of Ursoc in Azshara afterwards.", ["location"] = "Narkogg the Dark (Azshara - Maw of Ursoc "..NORMAL.."39, 21"..WHITE..")", ["note"] = "\'Ursol\' is at "..NORMAL.."[9]"..WHITE..".", ["attain"] = 60, ["level"] = 60, ["prequest"] = "Unbridled Darkness", ["rewards"] = { [1] = { ["id"] = 42235, ["name"] = "Eternal Essence of Purification", ["subtext"] = "Quest Item", ["icon"] = "INV_Misc_Flask_02", ["quality"] = 1 } } },
			[8]  = { ["id"] = 42022, ["title"] = "Hide of a Wild God",                ["aim"] = "Bring the Hide of Ursol to the furbolg of the Maw of Ursoc in Azshara.", ["location"] = "Corrupted Hide of Ursol (Timbermaw Hold "..NORMAL.."[9]"..WHITE..")", ["note"] = "\'Kathor the Brave\' is at Azshara - Maw of Ursoc "..NORMAL.."[39, 21]"..WHITE..".", ["attain"] = 60, ["level"] = 60, ["prequest"] = "Unbridled Darkness", ["rewards"] = { [1] = { ["id"] = 33324, ["name"] = "Breastplate of the Wild God",   ["subtext"] = L.CHEST..", "..L.PLATE,  ["icon"] = "INV_Chest_Plate07", ["quality"] = 3 }, [2] = { ["id"] = 33325, ["name"] = "Helmet of Natural Benevolence", ["subtext"] = L.HEAD..", "..L.LEATHER, ["icon"] = "INV_Helmet_32",     ["quality"] = 3 }, [3] = { ["id"] = 33326, ["name"] = "Leggings of Untamed Strength",  ["subtext"] = L.LEGS..", "..L.MAIL,   ["icon"] = "INV_Pants_Mail_14", ["quality"] = 3 } } },
			[9]  = { ["id"] = 41966, ["title"] = "Peroth\'arn, Nightmare\'s Herald", ["aim"] = "Enter Timbermaw Hold and destroy Peroth\'arn. Return to Narkogg the Dark in the Maw of Ursoc in Azshara after you have cleansed the corruption plagueing Kalimdor!", ["location"] = "Gorn One Eye (Timbermaw Tunnels "..NORMAL.."30, 64"..WHITE..")", ["note"] = "Prequest start at Nathok (Azshara - Maw of Ursoc "..NORMAL.."39, 20"..WHITE.."). \'Peroth\'arn\' is at "..NORMAL.."[10]"..WHITE..".", ["attain"] = 60, ["level"] = 60, ["prequest"] = "Purging Flames ("..NORMAL.."Molten Core"..WHITE..")", ["rewards"] = { [1] = { ["id"] = 42242, ["name"] = "Sacred Timbermaw Satchel", ["subtext"] = "Container", ["icon"] = "INV_Misc_Bag_11", ["quality"] = 3 } } },
			[10] = { ["id"] = 41937, ["title"] = "Nightmare\'s End",                 ["aim"] = "Deliver the Pendant of Dreams to the Great Bear Spirit in Moonglade.", ["location"] = "\'Pendant of Dreams\' drops from \'Ursol\' at "..NORMAL.."[9]"..WHITE..".", ["note"] = "Great Bear Spirit (Moonglade "..NORMAL.."39, 27"..WHITE..")", ["attain"] = 60, ["level"] = 60, ["rewards"] = { [1] = { ["id"] = 33327, ["name"] = "Branch of the Emerald Expanse", ["subtext"] = L.TWOHAND..", "..L.STAFF, ["icon"] = "INV_Staff_30",          ["quality"] = 3 }, [2] = { ["id"] = 33328, ["name"] = "Wispwoven Loop",   ["subtext"] = L.RING, ["icon"] = "INV_Jewelry_Ring_14",     ["quality"] = 3 }, [3] = { ["id"] = 33329, ["name"] = "Dreambark Amulet", ["subtext"] = L.NECK, ["icon"] = "INV_Jewelry_Necklace_07", ["quality"] = 3 } } },
			[11] = { ["id"] = 42009, ["title"] = "Loktanag the Pure",                 ["aim"] = "Vanquish Loktanag the Vile inside Timbermaw Hold and return to Muln Earthfury at the Earthen Ring in the Stonetalon Mountains.", ["location"] = "Muln Earthfury (Stonetalon Mountains - The Earthen Ring "..NORMAL.."49, 71"..WHITE..")", ["note"] = "\'Loktanag the Vile\' is at "..NORMAL.."[4]"..WHITE..".", ["attain"] = 60, ["level"] = 60 },
		},
	...
	[51] = {
		[1] = {
			[1] = {
				...
				["location"] = "Tarwegg Dustbrow (Ironforge - Hall of Explorers "..NORMAL.."72, 17"..WHITE..")",
		...
		[2] = {
			[1] = {
				...
				["location"] = "Sagh (Thousand Needles "..NORMAL.."31, 45"..WHITE..")",
				["note"] = "'Windhorn Relics' can be found throughout the entire dungeon.",
				["attain"] = 20,
				["level"] = 27,
				["rewards"] = {
			...
			[2] = {
				...
				["location"] = "Cairne Bloodhoof (Thunder Bluff "..NORMAL.."60, 52"..WHITE..")",
				["note"] = "Prequest start at 'Brave Moonhorn' (Thousand Needles - The Great Lift "..NORMAL.."32, 22"..WHITE.."). 'Prophet Stormhoof' is at "..NORMAL.."[6]"..WHITE..".",
				["attain"] = 24,
				["level"] = 28,
			...
			[3] = {
				...
				["location"] = "Shovu (Stonetalon Mountains - Earthen Ring "..NORMAL.."47, 72"..WHITE..")",
				["note"] = RED.."Shaman only! "..WHITE.."Prequest start from 'Windtorn Crest Stone', which drops from Razorgust in Stonetalon Mountains ("..NORMAL.."30, 19"..WHITE.."). 'Ambassador Vortalus' is at "..NORMAL.."[3]"..WHITE..".",
				["attain"] = 20,
				["level"] = 26,
			...
			[4] = {
				...
				["location"] = "Malgan Windhorn (Thousand Needles - Sagh's Refuge "..NORMAL.."31, 45"..WHITE..")",
	...
	[53] = {
		[1] = {
			[1] = {
				...
				["note"] = "'Tablet of Kaz'gan' is at "..NORMAL.."[3']"..WHITE..".",
				["location"] = "Ranix Crackbolt (Frostmane Hollow "..NORMAL.."[1']"..WHITE..")",
				["attain"] = 8,
				["level"] = 13,
			},
			[2] = {
				...
				["location"] = "Brohann Caskbelly (Stormwind City - The Dwarven District "..NORMAL.."70, 40"..WHITE..")",
				["note"] = "'Archaeologist Evenpike' is at "..NORMAL.."[2']"..WHITE..".",
				["attain"] = 10,
				["level"] = 14,
			...
			[3] = {
				...
				["location"] = "Archaeologist Evenpike (Frostmane Hollow "..NORMAL.."29, 62"..WHITE..")",
				["note"] = "'Brohann Caskbelly' (Stormwind City - The Dwarven District "..NORMAL.."70, 40"..WHITE..")",
				["attain"] = 10,
				["level"] = 14,
			...
			[4] = {
				...
				["location"] = "Shandlar Thethis (Thalassian Highlands - Alah'thalas "..NORMAL.."45, 46"..WHITE..")",
				["note"] = "'Tan'sha The Sleek' is at "..NORMAL.."[1]"..WHITE..".",
				["attain"] = 10,
				["level"] = 16,
				["rewards"] = {
					[1] = {
			...
			[5] = {
				...
				["location"] = "Mountaineer Granitebeard (Dun Morogh - Ironforge Airfield "..NORMAL.."71, 36"..WHITE..")",
				["note"] = "'Battlemaster Ubukaz' is at "..NORMAL.."[2]"..WHITE..".",
				["attain"] = 8,
				["level"] = 16,
