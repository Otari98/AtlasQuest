...
AtlasQuest.data = {
	...
	[14] = {
		[1] = {
			...
			[2] = {
				["note"] = "Lucifron is at "..NORMAL.."[1]|r, Sulfuron is at "..NORMAL.."[8]|r, Gehennas is at "..NORMAL.."[3]|r and Shazzrah is at "..NORMAL.."[5]|r.",
				["id"] = 6824,
				["attain"] = 55,
	...
	[50] = {
		[1] = {
			...
			[3] = {
				...
				["note"] = RED.."Mage only! |rDoorman Montigue is in Lower Karazhan Halls at the beginning of the dungeon in front of the stairs.",
				["attain"] = 60,
				["level"] = 61,
			...
			[6] = {
				...
				["note"] = RED.."Druid only! |rLorekeeper Lydros (Dire Maul - West or North "..NORMAL.."[1] Library|r). Quest line for [Glyph of the Arcane Treant] at Dire Maul East.",
				["attain"] = 60,
				["level"] = 61,
	...
	[51] = {
		...
		[2] = {
			...
			[3] = {
				...
				["note"] = RED.."Shaman only! |rPrequest start from 'Windtorn Crest Stone', which drops from Razorgust in Stonetalon Mountains ("..NORMAL.."30, 19|r). 'Ambassador Vortalus' is at "..NORMAL.."[3]|r.",
				["attain"] = 20,
				["level"] = 26,
